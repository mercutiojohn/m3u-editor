...
::v-deep .jsoneditor-menu>.jsoneditor-modes>button, ::v-deep .jsoneditor-menu>button {
  filter: invert(1);
}
::v-deep .jsoneditor-menu {
...
::v-deep .jsoneditor-contextmenu .jsoneditor-menu li button.jsoneditor-selected, .jsoneditor-contextmenu .jsoneditor-menu li button.jsoneditor-selected:focus, .jsoneditor-contextmenu .jsoneditor-menu li button.jsoneditor-selected:hover {
  color: #000;
